...
const guardar = async (evento) => {
    ...
    const url = '/final_is2_ramos/API/productos/guardar';
    const config = {
        method : 'POST',
        // body: otroNombre
        body
...
const buscar = async () => {
    ...
    const url = `/final_is2_ramos/API/productos/buscar?producto_nombre=${producto_nombre}&producto_precio=${producto_precio}`;
    const config = {
        method : 'GET'
    }
